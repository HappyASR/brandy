...
s32 aw1683_wr_reg(__u16 sub_addr, __u16 data)
{
	...
	ret = i2c_write(0x80000000, (uchar)0x10, (__u32)0xfe ,1 , (__u8*)&tmpData,2);
#if DEBUG
	...
	ret = i2c_write(0x80000000, (uchar)CONFIG_SYS_I2C_SLAVE, tmpData ,1 , (__u8*)&data,2);
#if DEBUG
...
s32 aw1683_rd_reg(__u16 sub_addr, __u16 *data)
{
	...
	ret = i2c_write(0x80000000, (uchar)CONFIG_SYS_I2C_SLAVE, i2cFixAddr ,1 , (__u8*)&tmpData,2);
#if DEBUG
	printf("-------read-----tmpdata1 = 0x%x, ret1 = 0x%x\n", tmpData, ret);
#endif

	tmpData = (u32)(sub_addr & 0xff);
	ret = i2c_read(0x80000000, (uchar)CONFIG_SYS_I2C_SLAVE, tmpData,1,(__u8*)data, 2);
#if DEBUG
